...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fa11ybasevi%2Fa11ybase-documents&project-name=my-documents&repository-name=my-documents&demo-title=Documents&demo-description=This%20Document%20Starter%20Kit%20is%20developed%20with%20Next.js%2C%20Tailwind%20CSS%20and%20TypeScript.%20It%20serves%20as%20a%20flexible%20and%20scalable%20foundation%20for%20building%20documentation%20websites%20or%20content-driven%20projects.&demo-url=https%3A%2F%2Fa11ybase-documents.vercel.app%2F&demo-image=https%3A%2F%2Fgithub.com%2Fa11ybasevi%2Fa11ybase-documents%2Fblob%2Fmain%2Fpublic%2Fscreens%2Fscreen-1.png)
...
```bash
git clone https://github.com/a11ybasevi/a11ybase-documents.git
```

Change the directory to the project folder:

```bash
cd a11ybase-documents
```
