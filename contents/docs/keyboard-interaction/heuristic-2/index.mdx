...
### What this means
When someone uses the keyboard to move around a page, typically by pressing the `Tab` key, there should be a clear visual indicator that shows where the current focus is. This could be a border, outline, glow, or any other style that stands out from the rest of the interface.
...
### What to check for
- Is there a clear visual change when tabbing to a button, link, or form field?
...
- Has the browser’s default `outline` style been removed without providing a replacement?
