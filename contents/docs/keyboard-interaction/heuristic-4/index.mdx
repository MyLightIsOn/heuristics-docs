...
### Why this matters
Not everyone uses a mouse. Many assistive technologies work with keyboard interactions. This means that for many users, the keyboard is their only way to navigate.  If they get stuck in a modal, menu, or embedded widget, they may have to reload the page or abandon their task entirely.
...
- Do custom components (e.g., menus, sliders, date pickers) all the user to enter and leave freely?
